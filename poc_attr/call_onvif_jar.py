...
def main():
	...
	print str(onvifX)
	print str(onvifY)
	#args = ['onvif.jar', '172.16.1.129', 'un', 'pw', onvifX, onvifY, '2.0'] # Any number of args to be passed to the jar file
	args = ['onvif.jar', '172.16.1.130', 'un', 'pw', onvifX, onvifY, '1.2']
	print "moving camera.."
